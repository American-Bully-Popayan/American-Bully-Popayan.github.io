...
<body>
    ...
    <div class="content">
        <h3>Te invitamos a conocer la camada</h3>
        ...
        <div class= "parrafo">
            ...
            <p>Ofrecemos cachorros American Bully para la venta con entregas personales y gratuitas en la ciudad de Popay&aacute;n, Cali, Tulu&aacute;, Pasto, Neiva, y envios al resto del pa&iacute;s. El mejor regalo para la familia y los ni&ntilde;os de la casa.<br>
            Los cachorros se venden con el aplicativo ABKC. Tienen una excelente gen&eacute;tica, son tama&ntilde;o pocket y f&iacute;sicamente son anchos y acuerpados, la mam&aacute; viene de uno de los mejores criaderos de Medell&iacute;n. Tanto el pap&aacute; como la mam&aacute; son criados en hogares con ni&ntilde;os y han tenido un comportamiento excelente, totalmente confiable, sobre todo con ni&ntilde;os inquietos, intensos y juguetones con las mascotas, que es el caso de nuestro hijo!!!<br>
            Conoce la historia de nuestra perrita <a href="https://www.instagram.com/p/CXFH0kgpTrM/?utm_medium=share_sheet" target="_blank">aqui</a>
            </p>
            </div>
        ...
        <div class= "parrafo">
            ...
            <span id="imagenA" class="Iparrafo"><img class="imagen" src="https://imgur.com/1n0olf9.jpeg" alt="perros american bully en venta_2" title="perros american bully en venta_2" width="580px"></span>
            <p>
            Son unos perros juguetones, vitales y cari&ntilde;osos, de car&aacute;cter dulce y apacible. Les encanta sentirse queridos y siempre intentan complacer en todo lo que se les pide. Estas aptitudes positivas no deben hacernos olvidar la importancia de la <a href="https://nfnatcane.es/blog/socializar-correctamente-a-un-perro/" target="_blank">socializaci&oacute;n temprana</a> para el desarrollo correcto y equilibrado del futuro perro adulto.<br>    
            Por todas sus caracter&iacute;sticas resultan ideales para familias, a pesar de que su aspecto puede asustar a algunas personas. Nada m&aacute;s lejos de la realidad, pues los American bully aceptan incluso a los desconocidos sin mostrar ning&uacute;n signo de agresividad.<br>    
            </p>
            <span id="imagenA" class="Iparrafo"><img class="imagen" src="https://imgur.com/GBHiuvO.jpeg" alt="perros american bully en venta_3" title="perros american bully en venta_3" width="580px"></span>
            <p>
            Son, en definitiva, perros sociables, equilibrados e inteligentes, lo que les ayuda a adquirir las normas b&aacute;sicas de educaci&oacute;n y dem&aacute;s trucos que se les quieran ense&ntilde;ar. Esto no implica que sea una raza recomendada para primerizos, pues su tenencia requiere poseer conocimientos previos sobre la psicolog&iacute;a canina y su educaci&oacute;n.<br>    
            </p>
            <span id="imagenA" class="Iparrafo"><img class="imagen" src="https://imgur.com/axNRSUW.jpeg" alt="perros american bully en venta_4" title="perros american bully en venta_4" width="580px"></span>
            <p>
